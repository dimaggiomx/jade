...
function submitForm(){
    ...
    $.ajax({
        ...
        .done(function(data){
            ...
            $('#btn-signup').html('<img src="ajax-loader.gif" /> &nbsp; Iniciando sesion...').prop('disabled', true);
            ...
            setTimeout(function(){
                ...
                if ( data.status==='success' ) {
                    ...
                    $('#errorDiv').slideDown('fast', function(){
                        ...
                        $('#btn-signup').html('<span class="glyphicon glyphicon-log-in"></span> &nbsp; Inicio exitoso...').prop('disabled', false);
