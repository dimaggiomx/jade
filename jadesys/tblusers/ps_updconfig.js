...
function submitForm(){
    ...
    $.ajax({
        ...
        .done(function(data){
            ...
            $('#btn-signup').html('<img src="ajax-loader.gif" /> &nbsp; Procesando...').prop('disabled', true);
            ...
            setTimeout(function(){
                ...
                if ( data.status==='success' ) {
                    ...
                    $('#errorDiv').slideDown('fast', function(){
                        ...
                        $('#btn-signup').html('<span class="glyphicon glyphicon-log-in"></span> &nbsp; Actualizada...').prop('disabled', false);
