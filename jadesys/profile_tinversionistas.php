...
require_once('config/actions/a.reginversionista.php');

$myData = NEW A_REG_INV("");
$result = $myData->get_inverionista_data($DBcon,$_SESSION['ses_id']);
