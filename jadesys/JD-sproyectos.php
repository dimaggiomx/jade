    ...
    <div class="container-fluid">
      <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Admin de Proyectos</h4>
        </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="documents/ps_logo.php" class="dropzone" id="dropzoneLogo">
                <div class="fallback">
                  <input name="file" type="file" multiple />
                </div>
                <input name="idP" id="idP" type="text" value="W" />
              </form>
      ...
      <div class="modal fade bs-example-modal-lg" id="modalUpd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
...
<!-- Custom Theme JavaScript -->
<script src="tadmin/ps_search.js"></script>
  <!-- para las tablas -->
