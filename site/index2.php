...
if ($resultado = $mysqli->query($query)) {
    while ($fila = $resultado->fetch_row()) {
        ...
        $salida .= '<div id="slidingDiv'.$contador.'" class="toggleDiv row-fluid single-project">
                        <div class="span6">
                            <iframe width="98%" height="300" src="https://www.youtube.com/embed/'.$fila[8].'?list=RDEoaPhxNubL0?ecver=1" frameborder="0" allowfullscreen></iframe>
                        ...
                        <div class="span6">
                            <div class="project-description">
                                ...
                                <div class="project-info">
                                    <div>
                                        <span>Ranking:</span> '.$fila[2].' </div>
                                    <div>
                                        <span>Evaluacion:</span> '.$fila[3].' </div>
                                    <div>
                                        <span>Inicio</span> '.$fila[11].'</div>
                                    <div>
                                        <span>Fin</span> '.$fila[12].'</div>
                                </div>
                                <p>'.$fila[7].'</p>
                                <p><a href="../jadesys/login.html" class="button2">Invertir</a> <a href="https://www.youtube.com/watch?v='.$fila[8].'" class="button2" target="_blank">Pitch</a></p>
                            </div>
                        </div>
                    </div>';
        ...
        $salida2 .= '<li class="span4 mix '.$fila[13].'">
                            <div class="thumbnail">
                                <img src="../jadesys/documents/'.$fila[15].'" alt="project 1">
